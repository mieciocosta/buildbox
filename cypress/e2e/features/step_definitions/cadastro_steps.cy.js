...
When('I partially fill the form and clear it', () => {
  cy.get('[data-cy="input-signup-personal-data-firstName"]').should('be.visible').type('abc').clear()
  cadastroPage.clickNextButton()
})

Then('I should see error messages for required fields after clearing them', () => {
